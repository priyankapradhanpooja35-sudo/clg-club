      ...
      <nav className="mx-auto w-full max-w-7xl">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex h-12 items-center justify-between">
            {/* Logo + Tagline */}
            <Link href="/" className="flex items-center gap-2.5 shrink-0 whitespace-nowrap group">
              <div className="flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-full overflow-hidden bg-white shadow-sm border border-slate-200/80 transition-transform duration-200 group-hover:scale-105">
              ...
              <div className="flex flex-row items-center gap-2 whitespace-nowrap shrink-0">
                <span className="text-sm sm:text-base font-bold text-[#1E293B] dark:text-white leading-none tracking-tight whitespace-nowrap">
                  BEC Club Hub
                </span>
                <span className="hidden 2xl:inline-block text-[11px] text-[#2563EB] dark:text-blue-400 font-semibold leading-none pl-2 border-l border-slate-200 dark:border-slate-700 whitespace-nowrap">
            ...
            {/* Desktop Nav Links */}
            <div className="hidden xl:flex items-center gap-1 bg-slate-100/60 p-1 rounded-full border border-slate-200/50 dark:bg-slate-800/50 dark:border-slate-700/50 shrink-0">
                ...
                return (
                  ...
                  >
                    <Link
                      href={href}
                      className={cn(
                        'relative block px-3 py-1.5 text-xs xl:text-sm font-semibold tracking-wide transition-all duration-200 ease-in-out rounded-full whitespace-nowrap',
                        isActive
                          ? 'text-white'
              ...
              {user ? (
                <>
                  <Link href={getDashboardHref()}>
                    <button className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-[#2563EB] bg-[#EFF6FF] border border-blue-200/80 hover:bg-blue-100 transition-all duration-200 ease-in-out dark:bg-blue-950/60 dark:text-blue-300 dark:border-blue-800 whitespace-nowrap">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-1.5 rounded-full px-2 py-1 border border-slate-200 bg-white hover:bg-[#EFF6FF] transition-all duration-200 ease-in-out dark:border-slate-700 dark:bg-slate-800 shrink-0"
                    >
                      <Avatar name={user.name} size="sm" />
                      <span className="hidden sm:block text-xs font-semibold text-[#1E293B] dark:text-slate-200 whitespace-nowrap">
                        {user.name.split(' ')[0]}
                      </span>
